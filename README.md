...
| `data_width_convertors/` | Parallel/serial converters, a variable-size-to-fixed-size data-width gearbox, and a byte-packing gearbox (holes removed via population count) |
